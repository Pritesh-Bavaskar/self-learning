    ...
    <footer className="bg-white pt-16 pb-8 border-t border-gray-100">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div>
            <h3 className="text-lg font-bold mb-4">SelfPrepare</h3>
            <p className="text-gray-600 mb-4">
              Helping students achieve their dream of getting into top B-schools
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a
                  href="mailto:contact@selfprepare.com"
                  className="text-gray-600 hover:text-gray-900 ml-1"
                >
                  contact@selfprepare.com
                </a>
              </li>
              <li className="flex items-start">
                <span className="text-gray-600">Phone: </span>
                <span className="text-gray-600 ml-1">+91 98765 43210</span>
              </li>
            </ul>
